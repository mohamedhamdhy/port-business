...
const GlobeIcon = () => (
  <svg viewBox="0 0 16 16" fill="none" width={12} height={12}>
    ...
    <path
      d="M8 2c-2 2-2 8 0 12M8 2c2 2 2 8 0 12M2 8h12"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at top right, ${color}18 0%, transparent 60%)`,
        }}
      />
      <svg
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(ellipse at bottom left, ${color}15 0%, transparent 60%)`,
        }}
      />
      <svg
        className="absolute inset-0 w-full h-full"
      ...
      >
        ...
        {['Today', 'Mon', 'Tue', 'Wed'].map((d, i) => (
          <g key={d}>
            <rect
              ...
              height="13"
              rx="3"
              fill={i === 0 ? `${color}30` : 'rgba(255,255,255,0.04)'}
              stroke={i === 0 ? `${color}40` : 'transparent'}
              strokeWidth="0.5"
            />
            <rect
              x="22"
              ...
              height="2"
              rx="1"
              fill={i === 0 ? 'rgba(255,255,255,0.6)' : 'rgba(255,255,255,0.2)'}
            />
            <rect
              x="22"
              y={53 + i * 16}
        ...
        {[
          [80, 30, 38, 22, 0.5, 'Cut & Style'],
          [120, 46, 55, 18, 0.35, 'Color'],
          [80, 52, 28, 18, 0.4, 'Blowout'],
          [145, 30, 45, 18, 0.3, 'Massage'],
          [183, 46, 30, 34, 0.45, 'Facial'],
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(ellipse at top right, ${color}15 0%, transparent 60%)`,
        }}
      />
      <svg
        className="absolute inset-0 w-full h-full"
      ...
      >
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          <rect
            ...
            height="13"
            rx="3"
            fill={i === 0 ? `${color}25` : 'rgba(255,255,255,0.03)'}
            stroke={i === 0 ? `${color}30` : 'transparent'}
            strokeWidth="0.5"
          />
        ))}
        <rect
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(ellipse at bottom right, ${color}12 0%, transparent 60%)`,
        }}
      />
      <svg
        className="absolute inset-0 w-full h-full"
        ...
        {[
          ...
          <g key={plan as string}>
            <rect
              ...
              height={18}
              rx="3"
              fill={i === 1 ? `${color}25` : 'rgba(255,255,255,0.03)'}
              stroke={i === 1 ? `${color}35` : 'transparent'}
              strokeWidth="0.5"
            />
            <text
              x={84 + i * 46}
    ...
    projects: [
      {
        ...
        tag: 'POS System',
        description:
          'Full-featured point-of-sale system for retail clothing stores — inventory management, barcode scanning, staff roles, and real-time sales analytics.',
      ...
      },
      {
        ...
        tag: 'Booking & POS',
        description:
          'Salon management platform combining appointment scheduling, client history, staff commissions, and integrated POS for seamless daily operations.',
      ...
      },
      {
        ...
        tag: 'Travel Platform',
        description:
          'Travel agency management tool handling flight bookings, package management, customer invoicing, and multi-currency payment processing.',
    ...
    projects: [
      {
        ...
        tag: 'CRM System',
        description:
          'Customer relationship management platform with pipeline tracking, lead scoring, activity logs, and team collaboration tools for growing sales teams.',
      ...
      },
      {
        ...
        tag: 'E-Commerce',
        description:
          'Multi-vendor e-commerce platform with product management, order tracking, payment gateway integration, and a responsive storefront.',
      ...
      },
      {
        ...
        tag: 'SaaS Platform',
        description:
          'Multi-tenant SaaS platform with subscription billing, role-based access, analytics dashboard, and modular feature toggles per plan tier.',
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="flex flex-col items-center text-center mb-14 sm:mb-16 lg:mb-20">
          ...
          >
            Work <span style={{ color: '#1E90FF' }}>Experience</span>
          </h2>
          ...
          >
            A track record of delivering production-grade software across
            industries — from retail POS systems to SaaS platforms and CRM
            tools.
          </p>
        </div>
        ...
        <div className="relative">
          <div
            ...
            style={{
              background:
                'linear-gradient(180deg, rgba(30,144,255,0.4), rgba(0,194,160,0.4), rgba(30,144,255,0.1))',
            }}
          />
            ...
            {companies.map((company, ci) => {
              ...
              return (
                <div key={company.id} className="relative">
                  <div
                    className={`hidden sm:flex absolute top-6 items-center justify-center z-10 ${isLeft ? 'lg:left-1/2' : 'lg:left-1/2'} left-6 -translate-x-1/2`}
                  >
                    <div
                  ...
                  <div className="sm:hidden flex items-center gap-3 mb-5">
                    <div
                      ...
                      style={{
                        borderColor: company.accentColor,
                        background: '#0A0F2C',
                        boxShadow: `0 0 10px ${company.accentColor}50`,
                      }}
                    />
                    <div
                  ...
                  <div
                    className={`sm:pl-16 lg:pl-0 lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 items-start`}
                  >
                    <div
                      className={`${isLeft ? 'lg:order-1 lg:text-right lg:flex lg:flex-col lg:items-end' : 'lg:order-2'} mb-6 lg:mb-0 lg:pt-1`}
                    >
                      <div
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-2">
                          {[
                            {
                              icon: <CalendarIcon />,
                              text: `${company.period} · ${company.duration}`,
                            },
                            { icon: <LocationIcon />, text: company.location },
                            { icon: <GlobeIcon />, text: company.mode },
                            {
                              icon: <BriefcaseIcon />,
                              text: `${company.projects.length} Projects Delivered`,
                            },
                          ].map(({ icon, text }) => (
                            <div key={text} className="flex items-center gap-2">
                              <span style={{ color: company.accentLight }}>
                                {icon}
                              </span>
                    ...
                    <div
                      className={`${isLeft ? 'lg:order-2' : 'lg:order-1'} flex flex-col gap-4`}
                    >
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              boxShadow: isActive
                                ? `0 0 28px ${company.accentColor}20`
